...
static const struct node_param texture2d_params[] = {
    ...
    {"width", NGLI_PARAM_TYPE_INT, OFFSET(params.width), {.i64=0},
              .desc=NGLI_DOCSTRING("width of the texture")},
    {"height", NGLI_PARAM_TYPE_INT, OFFSET(params.height), {.i64=0},
               .desc=NGLI_DOCSTRING("height of the texture")},
    {"min_filter", NGLI_PARAM_TYPE_SELECT, OFFSET(params.min_filter), {.i64=NGLI_FILTER_NEAREST}, .choices=&ngli_filter_choices,
                   .desc=NGLI_DOCSTRING("texture minifying function")},
    {"mag_filter", NGLI_PARAM_TYPE_SELECT, OFFSET(params.mag_filter), {.i64=NGLI_FILTER_NEAREST}, .choices=&ngli_filter_choices,
                   .desc=NGLI_DOCSTRING("texture magnification function")},
    {"mipmap_filter", NGLI_PARAM_TYPE_SELECT, OFFSET(params.mipmap_filter), {.i64=NGLI_MIPMAP_FILTER_NONE},
                      .choices=&ngli_mipmap_filter_choices,
                      .desc=NGLI_DOCSTRING("texture minifying mipmap function")},
    {"wrap_s", NGLI_PARAM_TYPE_SELECT, OFFSET(params.wrap_s), {.i64=NGLI_WRAP_CLAMP_TO_EDGE}, .choices=&wrap_choices,
               .desc=NGLI_DOCSTRING("wrap parameter for the texture on the s dimension (horizontal)")},
    {"wrap_t", NGLI_PARAM_TYPE_SELECT, OFFSET(params.wrap_t), {.i64=NGLI_WRAP_CLAMP_TO_EDGE}, .choices=&wrap_choices,
...
static const struct node_param texture3d_params[] = {
    ...
    {"height", NGLI_PARAM_TYPE_INT, OFFSET(params.height), {.i64=0},
               .desc=NGLI_DOCSTRING("height of the texture")},
    {"depth", NGLI_PARAM_TYPE_INT, OFFSET(params.depth), {.i64=0},
    ...
    {"wrap_t", NGLI_PARAM_TYPE_SELECT, OFFSET(params.wrap_t), {.i64=NGLI_WRAP_CLAMP_TO_EDGE}, .choices=&wrap_choices,
               .desc=NGLI_DOCSTRING("wrap parameter for the texture on the t dimension (vertical)")},
    {"wrap_r", NGLI_PARAM_TYPE_SELECT, OFFSET(params.wrap_r), {.i64=NGLI_WRAP_CLAMP_TO_EDGE}, .choices=&wrap_choices,
...
static const struct node_param texturecube_params[] = {
    {"format", NGLI_PARAM_TYPE_SELECT, OFFSET(format), {.i64=NGLI_FORMAT_R8G8B8A8_UNORM}, .choices=&format_choices,
               .desc=NGLI_DOCSTRING("format of the pixel data")},
    {"size", NGLI_PARAM_TYPE_INT, OFFSET(params.width), {.i64=0},
...
static int texture_prefetch(struct ngl_node *node)
{
    ...
    if (s->data_src) {
        ...
        case NGL_NODE_MEDIA: {
            struct hwupload_params hwupload_params = {
                .output_image_layouts = s->supported_image_layouts,
                .output_texture_params = *params,
            };
            return ngli_hwupload_init(node, &hwupload_params);
        }
