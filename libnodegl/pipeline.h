...
struct pipeline_params {
     ...
     * uniforms.
     */
    const struct block *ublock[NGLI_PROGRAM_SHADER_NB]; //TODO: move to resource_params
    struct buffer *ubuffer[NGLI_PROGRAM_SHADER_NB];     //TODO: move to resource_params
};
